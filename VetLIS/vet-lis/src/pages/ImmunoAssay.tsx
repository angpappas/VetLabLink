...
const ImmunoAssay: React.FC = (props) => {
    ...
    const [messages, setMessages] = useState<DataPage<ImmunoAssayDataType> | null>(null);
    ...
    const getColumnSearchProps = (dataIndex: DataIndex): ColumnType<ImmunoAssayDataType> => ({
    ...
    const columns: ColumnsType<ImmunoAssayDataType> = [
        {
            title: "Test time",
            dataIndex: "testTime",
            sorter: {
        ...
        },
        {
            ...
            dataIndex: "birthDate",
            sorter: {
                compare: (a: ImmunoAssayDataType, b: ImmunoAssayDataType) => {
    ...
    const fetchData = async () => {
        try {
            ...
            const tmpMessages: DataPage<ImmunoAssayDataType> = {
                currentPage: data.currentPage,
                pageSize: data.pageSize,
                totalRecords: data.totalRecords,
                data: data.data.map((x) => readImmunoassay(x, context?.testParameterSettings!))
            };
    ...
    const handleTableChange = (
        ...
        sorter: SorterResult<ImmunoAssayDataType> | SorterResult<ImmunoAssayDataType>[],
        extra: TableCurrentDataSource<ImmunoAssayDataType>
    ) => {
        setTableParams({
            pagination,
            ...filters,
    ...
    return (
        <div>
            <h2 className="titles">Immunoassay</h2>
