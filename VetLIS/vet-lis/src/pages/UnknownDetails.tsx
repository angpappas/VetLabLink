...
const UnknownDetails: React.FC = (props) => {
    ...
    const fetchData = async (id: number | string) => {
        ...
        setMessage(readUnknown(data.message, context?.testParameterSettings!));
    ...
    return (
        <>
            <div>
                ...
                >
                    <Link
                        to={!hasPrevious() ? "" : `/unknown/${hasPrevious()}`}
